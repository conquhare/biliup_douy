    ...
    <>
      ...
      <div className={styles.frameDownload}>
        ...
        <Form.InputNumber
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              ...
              默认延迟时间为 0 秒
              <br />
              <span style={{ color: 'var(--semi-color-warning)' }}>?? 修改后需要重载配置才能生效</span>
            </div>
          }
          placeholder="0"
          suffix="s"
        ...
        <Form.InputNumber
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              平台检测间隔时间，单位：秒。比如抖音所有主播检测完后会等待此时间再去重新检测。
              <br />
              单位：秒
              <br />
              <span style={{ color: 'var(--semi-color-warning)' }}>?? 修改后需要重载配置才能生效</span>
        ...
        <Form.InputNumber
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              单个主播检测间隔时间，单位：秒。比如抖音有10个主播，每个主播会间隔此时间检测。
              <br />
              如果不设置或设置为0，则使用平台检测间隔（event_loop_interval）。
              <br />
              单位：秒
              <br />
              <span style={{ color: 'var(--semi-color-warning)' }}>?? 修改后需要重载配置才能生效</span>
        ...
        <Form.InputNumber
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              ...
              <br />
              <span style={{ color: 'var(--semi-color-warning)' }}>?? 修改后需要重启程序才能生效</span>
            </div>
          }
          placeholder={5}
      ...
      <div className={styles.frameUpload}>
        ...
        <Form.Switch
          ...
          extraText={
            <div style={{ fontSize: '14px' }}>
              启用自动重启功能。当系统检测到空闲（无录制和上传任务）时，会自动重启程序以应用新配置。
              <br />
              <span style={{ color: 'var(--semi-color-warning)' }}>?? 修改后需要重启程序才能生效</span>
              <br />
              <span style={{ color: 'var(--semi-color-text-2)' }}>检测间隔：每分钟检查一次系统状态</span>
            </div>
          }
